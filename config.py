...
LINKEDIN_PERSONA = os.getenv(
    ...
    (
        ...
        "Your LinkedIn voice is direct, no-BS, plain-spoken, and experience-driven. "
        "You write like a human: varied rhythm, real specifics, never a stack of one-line fragments. "
